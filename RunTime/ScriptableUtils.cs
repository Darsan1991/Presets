...
namespace DGames.Presets.Utils
{
    public static class ScriptableUtils
    {
        ...
        public static object GetDefault(Type type,string name = null)
        {
            ...
            var path = GetScriptablePathForScriptableType(targetType);
        ...
        [UnityEditor.MenuItem("MyGames/Refresh/CacheScriptableCache")]
        public static void RefreshCacheScriptableCache()
        {
            _cacheScriptables.Clear();
